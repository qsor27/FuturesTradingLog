...
- **Deployment Process**: Follow tag-based release strategy documented in [deployment-and-release.md](./deployment-and-release.md) - regular commits to main do NOT trigger builds; only version tags create releases
