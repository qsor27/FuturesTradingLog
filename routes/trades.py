...
def trade_detail(trade_id):
    try:
        with DatabaseManager() as db:
            ...
            # Note: get_position_executions may need to be moved to positions repository
            # For now, keeping fallback data structure
            position_data = None
            ...
            if trade and trade.get('link_group_id'):
                try:
                    ...
                    # Note: group_stats needs to be implemented in statistics repository
                    group_stats = None
...
def update_notes(trade_id):
    ...
    with DatabaseManager() as db:
        success = db.trades.update_trade_details(trade_id, chart_url=chart_url, notes=notes,
                                                validated=validated, reviewed=reviewed)
