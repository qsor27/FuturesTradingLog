...
class Config:
    ...
    def discord_webhook_url(self) -> str:
        """Return Discord webhook URL for notifications"""
        return os.getenv('DISCORD_WEBHOOK_URL', '')

    @property
    def discord_notifications_enabled(self) -> bool:
        """Return True if Discord notifications are enabled"""
...
# All 18 Yahoo Finance supported timeframes (as of 2025-11-13)
...
# Deprecated: TIMEFRAME_PREFERENCE_ORDER no longer used
# OHLC sync now downloads all timeframes automatically after CSV imports
